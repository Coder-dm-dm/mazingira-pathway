...
├──data
├── models/
│   └── qwen2.5-7b-instruct-q4_k_m.gguf  <-- Must download manually (not on GitHub)
├── services/
    ├──__pycache__/
        ├──__init__.cpython-312.pyc
        ├──__init__.cpython-314.pyc
        ├──ai_handler.cpython-312.pyc
        ├──ai_handler.cpython-314.pyc
        ├──data_handler.cpython-312.pyc
        ├──data_handler.cpython-314.pyc
        ├──history_handler.cpython-312.pyc
        ├──history_handler.cpython-314.pyc
        ├──sms_sender.cpython-312.pyc
        ├──sms_sender.cpython-314.pyc
│   ├── __init__.py
│   ├── ai_handler.py
│   ├── data_handler.py
│   ├── history_handler.py
